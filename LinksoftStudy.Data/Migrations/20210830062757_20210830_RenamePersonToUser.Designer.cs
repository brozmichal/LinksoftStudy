...
namespace LinksoftStudy.Data.Migrations
{
    ...
    [Migration("20210830062757_20210830_RenamePersonToUser")]
    partial class _20210830_RenamePersonToUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinksoftStudy.Data.Models.UserEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LinksoftStudy.Data.Models.ContactContacteeEntity", b =>
                {
                    b.HasOne("LinksoftStudy.Data.Models.UserEntity", "Contact")
                        .WithMany("Contactees")
                        .HasForeignKey("ContactId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LinksoftStudy.Data.Models.UserEntity", "Contactee")
                        .WithMany("Contacts")
